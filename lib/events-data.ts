...
export const PRIVATE_DINING_HEADLINE = "Celebrate With Us";

export const PRIVATE_DINING_INTRO =
  "Fernway is an ideal setting for birthdays, intimate celebrations, and corporate gatherings. Our team offers customized menus, flexible seating, and attentive service to create memorable occasions.";

export const EVENT_ENQUIRY_TYPES = [
  "DJ & Lounge Nights",
  "Themed Evenings",
  "Weekend Sessions",
